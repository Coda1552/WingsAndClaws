...
public class WingsEntities {
    ...
    public static final EntityType<PlowheadEggEntity> PLOWHEAD_EGG = createEgg("icy_plowhead_egg", PlowheadEggEntity::new, 0.25f, 0.25F);
    public static final EntityType<MimangoEggEntity> MIMANGO_EGG = createEgg("mimango_egg", MimangoEggEntity::new, 0.1f, 0.1f);
