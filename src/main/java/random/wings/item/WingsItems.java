...
public class WingsItems {
    ...
    public static final Item ICY_PLOWHEAD_SHIELD = register("icy_plowhead_shield", new ShieldItem(new Item.Properties().group(GROUP).setISTER(() -> PlowheadShieldRenderer::new)));
