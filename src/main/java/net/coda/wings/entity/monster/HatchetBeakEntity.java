package net.coda.wings.entity.monster;
...
import net.coda.wings.client.WingsKeyBindings;
import net.coda.wings.client.WingsSounds;
import net.coda.wings.entity.TameableDragonEntity;
import net.coda.wings.entity.goal.HatchetBeakWanderGoal;
import net.coda.wings.resources.TamePointsManager;
...
public class HatchetBeakEntity extends TameableDragonEntity implements IFlyingAnimal {
    ...
    public static AttributeModifierMap.MutableAttribute registerHBAttributes() {
        return MonsterEntity.func_234295_eP_().createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.3).createMutableAttribute(Attributes.MAX_HEALTH, 40).createMutableAttribute(Attributes.FLYING_SPEED, 0.5).createMutableAttribute(Attributes.ATTACK_DAMAGE, 4);
    }
