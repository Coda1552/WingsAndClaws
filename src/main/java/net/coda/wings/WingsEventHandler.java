...
import net.coda.wings.network.CallHatchetBeaksPacket;
import net.coda.wings.network.HatchetBeakAttackPacket;
    ...
    public static void breakBlock(BlockEvent.BreakEvent event) {
        ...
        if (world instanceof World && !world.isRemote() && (material == Material.ICE || material == Material.PACKED_ICE)) {
            if (world.getRandom().nextInt(48) == 0) {
                ...
                world.addEntity(new ItemEntity((World) world, pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5, new ItemStack(WingsItems.GLACIAL_SHRIMP.get())));
            }
        }
    }
