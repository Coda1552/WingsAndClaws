package net.coda.wings.world.gen.feature;
...
public class WingsFeatures {
    ...
    public static final Feature<NoFeatureConfig> DED_NEST = register("ded_nest", new NestFeature(new ResourceLocation(WingsAndClaws.MOD_ID, "dumpy_egg_drake"), WingsEntities.DUMPY_EGG_DRAKE.get()));
    public static final Feature<NoFeatureConfig> HB_NEST = register("hb_nest", new NestFeature(new ResourceLocation(WingsAndClaws.MOD_ID, "hatchet_beak"), WingsEntities.HATCHET_BEAK.get()));
