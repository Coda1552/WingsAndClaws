...
public class PlowheadShieldModel extends Model {
    ...
    public PlowheadShieldModel() {
        ...
        this.front1.setPos(-0.5F, -6.0F, 0.0F);
        ...
        this.handle.setPos(0.0F, 2.0F, 1.5F);
