...
public class WingsKeyBindings {
    ...
    public static final KeyBinding HATCHET_BEAK_DESCENT = register("hatchetBeakDescent", 90);

    private static KeyBinding register(String name, int key) {
        KeyBinding keyBinding = new KeyBinding("key." + name, key, "key.categories.wingsandclaws");
        LIST.add(keyBinding);
        return keyBinding;
    }
}
