...
public class SugarscaleModel<T extends Entity> extends EntityModel<SugarscaleEntity> {
    ...
    @Override
    public void setupAnim(SugarscaleEntity entityIn, float f, float f1, float ageInTicks, float netHeadYaw, float headPitch) {
        float speed = 5.0f;
        float degree = 1.0f;
